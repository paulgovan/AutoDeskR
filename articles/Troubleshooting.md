...
Problem: I was able to create a bucket and upload a file, but I can’t
translate the file.

Solution: Each task requires different tokens with different scopes.
Make sure to create a token with the “<data:read> <data:write>” scopes
in order to translate a file.
