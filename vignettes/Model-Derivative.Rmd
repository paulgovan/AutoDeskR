...
Finally, to download the OBJ file locally. Use the `destfile` parameter to specify where the file should be saved:
...
To translate a supported file into STL format, use `translateStl()`, which follows the same pattern as `translateObj()`:
